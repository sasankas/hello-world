...
set JAVA_OPTIONS=-server -Xms512m -Xmx1g -Xss256k -XX:PermSize=512m -XX:MaxPermSize=512m -XX:+UseG1GC
set CATALINA_OPTS=%JAVA_OPTIONS% -Dartifactory.home="%ARTIFACTORY_HOME%" -Dfile.encoding=UTF8 -Djruby.compile.invokedynamic=false -Dartdist=zip
